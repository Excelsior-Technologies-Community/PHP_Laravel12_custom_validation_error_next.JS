...
"[project]/node_modules/@rive-app/canvas/rive.js [client] (ecmascript)", ((__turbopack_context__, module, exports) => {
                ...
                var Rive = (()=>{
                    ...
                    return function(moduleArg = {}) {
                        ...
                        m.onRuntimeInitialized = function() {
                            ...
                            m.CustomFileAssetLoader = d.extend("CustomFileAssetLoader", {
                            ...
                            m.CDNFileAssetLoader = d.extend("CDNFileAssetLoader", {
                            ...
                            m.FallbackFileAssetLoader = d.extend("FallbackFileAssetLoader", {
                                __construct: function() {
                                    this.__parent.__construct.call(this);
                                    this.kb = [];
                                },
                        ...
                        const ma = "createConicGradient createImageData createLinearGradient createPattern createRadialGradient getContextAttributes getImageData getLineDash getTransform isContextLost isPointInPath isPointInStroke measureText".split(" "), na = new function() {
                            function a() {
                                if (!b) {
                                    var l = document.createElement("canvas"), u = {
                                        alpha: 1,
                                        depth: 0,
                                        stencil: 0,
                                        antialias: 0,
                        ...
                        m.onRuntimeInitialized = function() {
                            ...
                            let l = 1;
                            var u = m.RenderImage.extend("CanvasRenderImage", {
                            ...
                            var qa = m.CanvasRenderer = g.extend("Renderer", {
                        ...
                        var $a, ab, eb = {
                            ...
                            486212: (a)=>window.h.qa(a).L.sampleRate,
                            486285: (a)=>{
                                a = window.h.qa(a);
                        ...
                        var vd = (a, b)=>{
                            ...
                            n = {
                                "%a": (l)=>x[l.S].substring(0, 3),
                                "%A": (l)=>x[l.S],
                                "%b": (l)=>y[l.Fa].substring(0, 3),
                                "%B": (l)=>y[l.Fa],
                                "%C": (l)=>f((l.da + 1900) / 100 | 0, 2),
                                "%d": (l)=>f(l.Ra, 2),
                                "%e": (l)=>e(l.Ra, 2, " "),
                                "%g": (l)=>p(l).toString().substring(2),
                                "%G": p,
                                "%H": (l)=>f(l.Ea, 2),
                                "%I": (l)=>{
                                    l = l.Ea;
                                ...
                                "%M": (l)=>f(l.pc, 2),
                                "%n": ()=>"\n",
                                "%p": (l)=>0 <= l.Ea && 12 > l.Ea ? "AM" : "PM",
                                "%S": (l)=>f(l.qc, 2),
                                "%t": ()=>"\t",
                                "%u": (l)=>l.S || 7,
                                "%U": (l)=>f(Math.floor((l.ca + 7 - l.S) / 7), 2),
                                "%V": (l)=>{
                                ...
                                "%w": (l)=>l.S,
                                "%W": (l)=>f(Math.floor((l.ca + 7 - (l.S + 6) % 7) / 7), 2),
...
//# sourceMappingURL=node_modules_%40rive-app_canvas_rive_7ad8d180.js.map